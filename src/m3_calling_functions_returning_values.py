...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 16
    answer = sum_of_digits(754)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 21
    answer = sum_of_digits(9345)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def digits_in_power(n, k):
    ...
    power_digits = sum_of_digits(n**k)
    return power_digits
...
def fancy_sums_of_digits(n):
    ...
    ####################################################################
    # ------------------------------------------------------------------
    fancy_x = sum_of_digits(n ** 1000)
    fancy_y = sum_of_digits(n ** 999)
    fancy = sum_of_digits(fancy_x ** fancy_y)
