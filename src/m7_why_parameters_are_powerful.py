...
def main():
    ...
    run_test_even_better_draw_circles(3, 40, 250, 300)
...
def run_test_better_draw_circles(r):
    print()
    print('--------------------------------------------------')
    print('Testing  better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    better_draw_circles(r)
...
def even_better_draw_circles(dr, n, x, y):
    window = rg.RoseWindow(400, 400)
...
def run_test_even_better_draw_circles(dr, n, x, y):
    print()
    print('--------------------------------------------------')
    print('Testing  even_better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(dr, n, x, y)
